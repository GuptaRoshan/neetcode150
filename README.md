...
| 42          | Hard       | [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/)             |          | calculate `leftMax and rightMax` <br/> `leftMax < rightMax` : water can be trapped in the left section else right section <br/> `leftMax - height[left] and rightMax - height[right]` : No. of units can be trapped in left and right section |
